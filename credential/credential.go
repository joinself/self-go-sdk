...
const (
	...
	CredentialTypeFacialComparison            = "FacialComparisonCredential"
	CredentialTypeLivenessAndFacialComparison = "LivenessAndFacialComparisonCredential"
	CredentialTypeBiometricAnchor             = "BiometricAnchorCredential"
	CredentialTypeSharingAgreement            = "SharingAgreementCredential"
...
func newCredential(ptr *C.self_credential) *Credential {
	...
	runtime.AddCleanup(c, func(ptr *C.self_credential) {
...
func newCredentialBuilder(ptr *C.self_credential_builder) *CredentialBuilder {
	...
	runtime.AddCleanup(b, func(ptr *C.self_credential_builder) {
...
func newVerifiableCredential(ptr *C.self_verifiable_credential) *VerifiableCredential {
	...
	runtime.AddCleanup(c, func(ptr *C.self_verifiable_credential) {
...
// claimKey must be a valid json pointer
